# Caché offline y búsqueda

## Purpose

Definir cómo la aplicación permanece útil sin conexión y cómo encuentra notas con baja latencia sin consultar Drive en cada pulsación.
