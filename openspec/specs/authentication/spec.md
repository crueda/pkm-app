...
Definir cómo la aplicación obtiene autorización temporal para operar sobre los archivos de Google Drive sin backend, sin manejar contraseñas y sin persistir credenciales sensibles.
